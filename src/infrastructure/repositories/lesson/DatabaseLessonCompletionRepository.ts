...
import type { LessonCompletion as LessonCompletionRow } from "@/infrastructure/database/schema";
import { lessonCompletions } from "@/infrastructure/database/schema/learning-path.schema";

/**
 * Database implementation of LessonCompletion repository
 */
export class DatabaseLessonCompletionRepository
  implements ILessonCompletionRepository
{
   ...
   */
  private mapToEntity(row: LessonCompletionRow): LessonCompletion {
