...
import type { UserProgress as UserProgressRow } from "@/infrastructure/database/schema";
import { userProgress } from "@/infrastructure/database/schema/gamification.schema";

/**
 * Database implementation of UserProgress repository
 */
export class DatabaseUserProgressRepository implements IUserProgressRepository {
   ...
   */
  private mapToAggregate(row: UserProgressRow): UserProgress {
