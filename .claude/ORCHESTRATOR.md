...
This document provides instructions for Claude Code to orchestrate multi-agent code reviews. As the orchestrator, you coordinate specialist agents to provide comprehensive, actionable feedback.
